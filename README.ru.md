...
-  **Таймеры** — timed-квесты засекают часы и платят пропорционально времени.
-  **Роадмапы-графы** — узлы с пререквизитами образуют настоящий направленный ациклический граф.
